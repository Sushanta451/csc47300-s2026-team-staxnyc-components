/**
 * scrollAnimations.js
 * Call initScrollAnimations() once in main.jsx after the app mounts.
 * Uses IntersectionObserver — no libraries needed.
 *
 * Add these classes to any element to animate it on scroll:
 *   scroll-fade-up      — fades up from below
 *   scroll-fade-left    — slides in from left
 *   scroll-fade-right   — slides in from right
 *   scroll-scale        — scales up from small
 *   scroll-stagger      — parent: children animate in sequence
 */
