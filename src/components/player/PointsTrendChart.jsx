/**
 * PointsTrendChart.jsx — Fully dynamic bar chart
 * - Bars scale correctly to actual pts values
 * - Green bars for wins, red for losses
 * - Shows actual game date + opponent on each bar
 * - Average line drawn across chart
 * - Hover tooltip with full game details
 */
...
export default function PointsTrendChart({ games, avgPpg }) {
  ...
  // Show games oldest → newest (left to right)
