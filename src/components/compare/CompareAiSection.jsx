...
/**
 * Integrated AI-style comparison: rule-based narrative now; swap `buildLocalComparisonNarrative`
 * for an Edge Function + LLM when you have a secure backend (do not ship service keys in Vite).
 */
