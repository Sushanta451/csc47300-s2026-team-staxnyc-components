...
// Hook: animates elements with data-scroll attribute when they enter viewport
  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        ...
        setLoading(false)
        // Small delay so DOM elements exist before observer runs
  ...
  return (
    <>
      ...
      <main className="container">
        ...
        {/* Charts — slide in from sides when scrolled to */}
        {games.length > 0 && (
